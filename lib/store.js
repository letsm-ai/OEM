...
// Store tier discount — set to 0 across the board.
// Membership tier discounts now apply ONLY to consultations and events
// (see TIER_DISCOUNT in /lib/membership.js). Store purchases are full-price.
