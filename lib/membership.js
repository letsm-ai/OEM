...
export const TIER_META = {
  ...
  GOLD: {
    ...
    benefitsEn: [
      ...
      '12% discount on events & exhibitions',
  ...
  PLATINUM: {
    ...
    benefits: [
      ...
      'خصم 20% على الاستشارات والفعاليات',
    ...
    benefitsEn: [
      ...
      '20% discount on consultations, events & exhibitions',
